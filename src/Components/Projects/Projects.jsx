...
function Projects() {
  return (
    <div id="projects" className=" w-full bg-gray-100 lg:py-8 relative ">
        <div className="col-span-2  p-4 flex flex-col justify-center items-center gap-4 lg:mb-8 pt-8">
